...
def frame3():
    ...
    del_button = Button(framel3, text = "Delete row", command = delete_button)
    ...
    append_b = Button(framel3, text = "Append details", command= append_list)
...
def print_details():
    ...
    Label(framel2, text = "Name", bg = "white").grid(row=0, column=2)
